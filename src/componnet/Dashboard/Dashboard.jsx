...
//         <button className="absolute text-gray-600 lg:hidden top-4 left-4" onClick={toggleSidebar}>
...
//                   <div className="flex flex-col items-center p-4 text-white bg-blue-600 rounded-lg shadow-lg">
//                     <AiOutlineOrderedList className="text-2xl" />
//                     <h3 className="text-xl font-semibold">Orders</h3>
//                     <span className="text-4xl font-bold">250</span>
//                     <p>Pending Orders</p>
//                   </div>
//                   <div className="flex flex-col items-center p-4 text-white bg-green-600 rounded-lg shadow-lg">
//                     <AiOutlineProduct className="text-2xl" />
//                     <h3 className="text-xl font-semibold">Products</h3>
//                     <span className="text-4xl font-bold">100</span>
//                     <p>In Stock</p>
//                   </div>
//                   <div className="flex flex-col items-center p-4 text-white bg-orange-600 rounded-lg shadow-lg">
//                     <FaUsers className="text-2xl" />
//                     <h3 className="text-xl font-semibold">Customers</h3>
//                     <span className="text-4xl font-bold">120</span>
//                     <p>Active Customers</p>
//                   </div>
//                   <div className="flex flex-col items-center p-4 text-white bg-red-600 rounded-lg shadow-lg">
...
//               {/* Recent Orders */}
//               <div className="p-2 mt-4 bg-white rounded-lg shadow-md">
//       <div className="p-4 bg-gray-200 shadow-2xl rounded-xl">
//         <h2 className="mb-4 text-xl font-semibold">Recently Orders</h2>
//         <table className="min-w-full border-collapse border-gray-300 table-auto border-x-2 border-y-2">
//           <thead>
//             <tr className="bg-gray-100">
//               <th className="p-3 text-left border-b-2 border-r-2">Order ID</th>
//               <th className="p-3 text-left border-b-2 border-r-2">Customer</th>
//               <th className="p-3 text-left border-b-2 border-r-2">Product</th> {/* New Product Column */}
//               <th className="p-3 text-left border-b-2 border-r-2">Status</th>
//               <th className="p-3 text-left border-b-2">Date</th>
//             </tr>
//           </thead>
//           <tbody>
//             {recentOrders.map((order) => (
//               <tr key={order.id} className="bg-white hover:bg-gray-50">
//                 <td className="p-3 text-left border-b-2 border-r-2">{order.orderId}</td>
//                 <td className="p-3 text-left border-b-2 border-r-2">{order.customer}</td>
//                 <td className="p-3 text-left border-b-2 border-r-2">
//                   {/* Product Image */}
//                   <img src={order.productImage} alt="Product" className="object-cover w-12 h-12 rounded-full" />
//                 </td>
//                 <td className="p-3 text-left border-b-2 border-r-2">
...
//                   )}
//                 </td>
//                 <td className="p-3 text-left border-b-2 border-r-2">{order.date}</td>
//               </tr>
//             ))}
//           </tbody>
//         </table>
