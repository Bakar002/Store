...
const Navbar = () => {
  ...
  <NavLink to="/">
    <img
      src="https://www.belikegroup.org/static/media/logo.3a3cb8d082342adf9151.png" // Replace with your logo image path
      alt="Logo"
      className="w-12 h-16 sm:w-32  rounded-full sm:ml-4 ml-6" // Adjust size as needed
    />
  </NavLink>
</div>
        ...
        {/* Cart, Profile, and Create Account */}
        <div className="flex items-center space-x-4">
          ...
          {/* Create Account */}
          <NavLink to="/user-account" className="hidden px-4 py-2 font-medium transition bg-teal-800 rounded-lg md:block hover:bg-teal-700">
            User
          </NavLink>
          <NavLink to="/create-account" className="hidden px-4 py-2 font-medium transition bg-teal-800 rounded-lg md:block hover:bg-teal-700">
            Saler
          </NavLink>
          <NavLink to="/admin-account" className="hidden px-4 py-2 font-medium transition bg-teal-800 rounded-lg md:block hover:bg-teal-700">
            Admin
          </NavLink>
        </div>
